...

{
  ...
  public function __construct($row) {  //row coming back from DB
 $this->id = isset ($row['id']) ? interval
  ...
  public function create(){
    ...
    $sql = 'INSERT INTO Work (team_id, task_id, start_date, hours_worked)
    VALUES (?,?,?,?,?) ';

    $statement = $db->prepare($sql);
    $success = $statemtn -> execute([
      $this->team_id,
    ])
  }
